...
import uciipLogo from '@/assets/uciip.png';
    ...
    try {
      ...
      if (response.success) {
        if (response.requires2FA) {
          ...
          // Direct login if no 2FA (though backend currently requires it)
          navigate('/page');
        }
      }
    } catch (error: any) {
      setLoginAttempts(prev => prev + 1);
      setLoginError(error.message || 'Invalid credentials. Please verify your username/email and password.');
